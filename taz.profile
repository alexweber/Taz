...
function taz_install_tasks() {
  return array(
    'taz_backup_migrate' => array(
      'display_name' => st('Configure Backup & Migrate'),
      'display' => TRUE,
...
/**
 * Defines batch operation for settings vocabulary permissions.
 */
function taz_backup_migrate() {
  // Set destination.
  $fields = array(
